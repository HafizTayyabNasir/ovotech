...
# I need to replace the entire dropdown block. 
# Let's find it.
start = content.find("{/* Desktop Mega Menu Dropdown */}")
...
content = content[:start] + new_dropdown + "\n              " + content[end:]

with open(r'd:\Ovotech\ovotech-main\ovotech-main\src\components\Navbar.js', 'w', encoding='utf-8') as f:
    f.write(content)

print("Dropdown restructured to use robust pt-[14px] transparent spacer.")