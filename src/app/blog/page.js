    ...
    >
      <div style={{ display: "grid", gap: "40px" }}>
        ...
        <article style={{ borderBottom: "1px solid #E0E8F5", paddingBottom: "30px" }}>
          <span style={{ fontSize: "12px", color: "#00A8E8", fontWeight: "700", textTransform: "uppercase" }}>Industry News</span>
          ...
          <Link href="#" style={{ color: "#00A8E8", fontWeight: "600", fontSize: "14px" }}>Read Article &rarr;</Link>
        </article>

        <article style={{ borderBottom: "1px solid #E0E8F5", paddingBottom: "30px" }}>
          <span style={{ fontSize: "12px", color: "#00A8E8", fontWeight: "700", textTransform: "uppercase" }}>Product Update</span>
        ...
        <article>
          <span style={{ fontSize: "12px", color: "#00A8E8", fontWeight: "700", textTransform: "uppercase" }}>Case Study Highlight</span>
