  ...
  return (
    ...
    >
      ...
      <div style={{ border: "1px solid #E0E8F5", padding: "24px", borderRadius: "12px", marginBottom: "16px", background: "#fff" }}>
        ...
        <Link href="/contact?type=apply" style={{ padding: "8px 16px", display: "inline-block", background: "#02ACEA", color: "#fff", borderRadius: "8px", fontWeight: 600, fontSize: "14px" }}>Apply Now</Link>
      </div>
      <div style={{ border: "1px solid #E0E8F5", padding: "24px", borderRadius: "12px", marginBottom: "16px", background: "#fff" }}>
