...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      <h2 style={{ fontSize: "24px", color: "#0A1838", marginBottom: "16px" }}>1. Introduction</h2>
      ...
      <h2 style={{ fontSize: "24px", color: "#0A1838", marginBottom: "16px" }}>2. Information We Collect</h2>
      <p style={{ marginBottom: "24px", color: "#475569" }}>
      ...
      <h2 style={{ fontSize: "24px", color: "#0A1838", marginBottom: "16px" }}>3. How We Use Your Information</h2>
      <p style={{ marginBottom: "24px", color: "#475569" }}>
