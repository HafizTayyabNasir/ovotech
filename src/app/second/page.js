    ...
    <>
        ...
        <div className="max-w-[1350px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-6 border border-[#E0E8F5] shadow-sm hover:-translate-y-1 hover:shadow-md transition-all">
                <div className="text-[#02ACEA] font-extrabold text-[24px] mb-3">{step.num}</div>
                <h3 className="text-[#0A1838] font-bold text-[18px] mb-2">{step.title}</h3>
      ...
      <section className="py-20 bg-[#F4F7FC]">
        <div className="max-w-[1350px] mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <h2 className="text-[clamp(28px,3.5vw,40px)] font-extrabold text-[#0A1838] mt-2 mb-4">The right information for the right role.</h2>
            <p className="text-[#475569] text-[16px] max-w-2xl mx-auto">Access follows responsibility. Each person sees the information and actions needed for their work.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-[#E0E8F5] shadow-sm relative overflow-hidden">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1350px] mx-auto px-6 lg:px-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-[12px] font-bold text-[#475569]">
            <div className="bg-[#F8FAFC] px-4 py-2 rounded-lg border border-[#E0E8F5]">01 Clinical document <span className="font-normal block text-[10px] text-gray-500 mt-1">source retained</span></div>
            <div className="text-[#02ACEA] self-center">→</div>
            <div className="bg-[#F8FAFC] px-4 py-2 rounded-lg border border-[#E0E8F5]">02 Processing <span className="font-normal block text-[10px] text-gray-500 mt-1">information structured</span></div>
            <div className="text-[#02ACEA] self-center">→</div>
            <div className="bg-[#F8FAFC] px-4 py-2 rounded-lg border border-[#E0E8F5]">03 Suggestions <span className="font-normal block text-[10px] text-gray-500 mt-1">evidence presented</span></div>
            <div className="text-[#02ACEA] self-center">→</div>
            <div className="bg-blue-50 text-blue-900 px-4 py-2 rounded-lg border border-blue-200 shadow-sm">04 Human review <span className="font-normal block text-[10px] text-blue-700 mt-1">accept, amend or reject</span></div>
            <div className="text-[#02ACEA] self-center">→</div>
            <div className="bg-green-50 text-green-900 px-4 py-2 rounded-lg border border-green-200">05 Approval <span className="font-normal block text-[10px] text-green-700 mt-1">explicit authorisation</span></div>
            <div className="text-[#02ACEA] self-center">→</div>
            <div className="bg-[#F8FAFC] px-4 py-2 rounded-lg border border-[#E0E8F5]">06 Patient record <span className="font-normal block text-[10px] text-gray-500 mt-1">controlled write-back</span></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1350px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              ...
              <div key={i} className="bg-[#F8FAFC] rounded-2xl p-6 border border-[#E0E8F5] shadow-sm text-center">
                <h3 className="font-bold text-[#0A1838] text-[16px] mb-3">{item.title}</h3>
          ...
          <div className="bg-[#0A1838] rounded-3xl p-8 lg:p-12 mb-12 flex flex-col md:flex-row items-center justify-between gap-8 text-white shadow-xl">
            ...
            <Link href="/security" className="whitespace-nowrap px-6 py-3 bg-white text-[#0A1838] font-bold rounded-full hover:bg-gray-100 transition-colors">
              View the security approach →
            </Link>
          </div>

          <div className="text-center">
            <span className="text-[11px] font-bold text-[#64748B] uppercase tracking-widest mb-6 block">Assurance you can build on</span>
            <div className="flex flex-wrap justify-center gap-4 lg:gap-10 opacity-70 grayscale">
              <div className="text-center"><div className="font-bold text-[#0A1838] text-[18px]">DTAC</div><div className="text-[11px] text-[#475569]">Assessed</div></div>
              <div className="text-center"><div className="font-bold text-[#0A1838] text-[18px]">DSPT</div><div className="text-[11px] text-[#475569]">Standards met</div></div>
              <div className="text-center"><div className="font-bold text-[#0A1838] text-[18px]">ISO 27001</div><div className="text-[11px] text-[#475569]">Certified</div></div>
              <div className="text-center"><div className="font-bold text-[#0A1838] text-[18px]">Cyber Essentials</div><div className="text-[11px] text-[#475569]">Certified</div></div>
            </div>
          </div>
        </div>
      </section>
