...
export default function SecurityCompliancePage() {
  return (
    ...
    >
      <h2 style={{ fontSize: "28px", color: "#0A1E5C", marginBottom: "20px" }}>NHS Accredited & DSPT Compliant</h2>
      ...
      <h2 style={{ fontSize: "28px", color: "#0A1E5C", marginBottom: "20px" }}>GDPR Compliance</h2>
      <p style={{ marginBottom: "20px" }}>
      ...
      <h2 style={{ fontSize: "28px", color: "#0A1E5C", marginBottom: "20px" }}>Clinical Safety</h2>
      <p style={{ marginBottom: "20px" }}>
