...
export const metadata = {
  title: "Patient History Context | Ovotech Solutions",
  description: "Contextual patient medical record background alongside incoming correspondence for UK GP clinical document processing."
};

const capabilities = [
  {
    icon: "🩺",
    title: "Instant Record Overview",
    desc: "Surfaces active diagnoses, current repeat medications, and known allergies directly next to the incoming document."
  },
  {
    icon: "🔄",
    title: "Duplicate Code Prevention",
    desc: "Flags whether a clinical condition or diagnosis mentioned in the document is already recorded in the patient's EMIS chart."
  },
  {
    icon: "⚠️",
    title: "Allergy & Interaction Alerts",
    desc: "Highlights potential drug changes or new allergy statements in secondary care letters against historical records."
  },
  {
    icon: "📜",
    title: "Historical Encounter Timeline",
    desc: "Provides a chronological view of recent outpatient visits, blood tests, and prior secondary care correspondence."
  }
];
  ...
  return (
    <>
      <PageHeader 
        ...
        description="Empower clinical reviewers with immediate patient record context—minimising clinical risk and preventing duplicate coding." 
      />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "60px", alignItems: "center" }}>
            <div>
              ...
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 800, color: "#0A1838", lineHeight: 1.2, marginBottom: "20px" }}>
                Complete Patient Context at Your Fingertips
              </h2>
              <p style={{ fontSize: "16px", color: "#475569", lineHeight: 1.8, marginBottom: "24px" }}>
                Reviewing hospital correspondence without knowing the patient&apos;s background increases the risk of duplicate coding, missed drug contraindications, or erroneous clinical record entries. Ovotech brings active problem lists and historical entries into the review panel.
              </p>
              
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "32px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "15px", fontWeight: 600, color: "#0A1838" }}>
                  <span style={{ color: "#02ACEA", fontWeight: 800 }}>✓</span> Real-time synchronization with active patient record
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "15px", fontWeight: 600, color: "#0A1838" }}>
                  <span style={{ color: "#02ACEA", fontWeight: 800 }}>✓</span> Duplicate diagnosis detection &amp; conflict warnings
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "15px", fontWeight: 600, color: "#0A1838" }}>
                  <span style={{ color: "#02ACEA", fontWeight: 800 }}>✓</span> Allergy &amp; medication change tracking
                </div>
              </div>
            ...
            <div style={{ position: "relative" }}>
              <div style={{ borderRadius: "24px", overflow: "hidden", border: "1px solid #E0E8F5", boxShadow: "0 20px 50px rgba(10,24,56,0.12)" }}>
                <img src="/step4-patient-history.png" alt="Patient History Display" style={{ width: "100%", height: "420px", objectFit: "cover", display: "block" }} />
              </div>
              <div style={{ position: "absolute", bottom: "24px", left: "-12px", background: "#FFFFFF", padding: "14px 20px", borderRadius: "16px", boxShadow: "0 12px 35px rgba(0,0,0,0.12)", border: "1px solid #E0E8F5" }}>
                <div style={{ fontSize: "12px", fontWeight: 800, color: "#02ACEA" }}>Clinical Safety</div>
                <div style={{ fontSize: "11px", color: "#64748B" }}>0 Duplicate Codes Recorded</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: "60px 0", background: "#B332D2", color: "#FFFFFF" }}>
        <div className="site-container" style={{ textAlign: "center" }}>
          ...
          <Link href="/solutions/snomed-coding" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#02ACEA", color: "#FFFFFF", fontWeight: 700, fontSize: "14px", padding: "12px 24px", borderRadius: "10px" }}>
            View SNOMED CT Coding Support <span>→</span>
          </Link>
        </div>
      </section>
