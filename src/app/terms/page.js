...
export default function TermsPage() {
  return (
    ...
    >
      <h2 style={{ fontSize: "24px", color: "#0A1E5C", marginBottom: "16px" }}>1. Acceptance of Terms</h2>
      ...
      <h2 style={{ fontSize: "24px", color: "#0A1E5C", marginBottom: "16px" }}>2. Use License</h2>
      <p style={{ marginBottom: "24px" }}>
      ...
      <h2 style={{ fontSize: "24px", color: "#0A1E5C", marginBottom: "16px" }}>3. Limitations</h2>
      <p style={{ marginBottom: "24px" }}>
