  ...
  return (
    ...
    >
      ...
      <ul style={{ listStyleType: "disc", paddingLeft: "20px", marginBottom: "40px", color: "#475569" }}>
        <li style={{ marginBottom: "10px" }}><strong style={{ color: "#0A1838" }}>Reduce Admin Workload:</strong> Automate up to 70% of routine paperwork.</li>
        <li style={{ marginBottom: "10px" }}><strong style={{ color: "#0A1838" }}>Improve Patient Access:</strong> Digital triage and automated booking systems reduce phone queue wait times.</li>
        <li style={{ marginBottom: "10px" }}><strong style={{ color: "#0A1838" }}>Staff Retention:</strong> Remove the tedious tasks that lead to staff burnout.</li>
        <li style={{ marginBottom: "10px" }}><strong style={{ color: "#0A1838" }}>Seamless Integration:</strong> Works quietly in the background with EMIS Web, SystmOne, and Vision.</li>
      </ul>
    </InnerPageLayout>
  );
}
