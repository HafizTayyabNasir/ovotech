  ...
  return (
    ...
    >
      ...
      <ul style={{ listStyleType: "disc", paddingLeft: "20px", marginBottom: "40px" }}>
        <li style={{ marginBottom: "10px" }}><strong>High-Volume Processing:</strong> Enterprise RPA bots capable of handling thousands of transactions per minute.</li>
        <li style={{ marginBottom: "10px" }}><strong>Interoperability:</strong> Connect disparate hospital systems (EPR, PAS, LIMS) without complex API development.</li>
        <li style={{ marginBottom: "10px" }}><strong>Clinical Coding:</strong> AI-assisted coding to improve accuracy and optimize funding.</li>
        <li style={{ marginBottom: "10px" }}><strong>Stringent Security:</strong> fully compliant with NHS Data Security and Protection Toolkit (DSPT) and DCB0129/0160.</li>
      </ul>
    </InnerPageLayout>
  );
}
