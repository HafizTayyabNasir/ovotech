...
export default function ComplianceSection() {
  ...
  return (
    <section style={{ background: "#ffffff", padding: "100px 0", color: "#1A2848", position: "relative", overflow: "hidden" }}>
      ...
      <div className="site-container" style={{ position: "relative", zIndex: 10 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "56px" }}>
          ...
          <h2 style={{ fontSize: "clamp(32px, 4.5vw, 48px)", fontWeight: 800, color: "#1A2848", letterSpacing: "-0.5px", lineHeight: 1.15 }}>
          ...
          >
            <div style={{
              ...
              <div>
                ...
                <h3 style={{ fontSize: "clamp(26px, 3.5vw, 36px)", fontWeight: 800, color: "#1A2848", marginBottom: "16px", lineHeight: 1.2 }}>
                  {activeTab.title}
                </h3>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "32px" }}>
                  {activeTab.bullets.map((bullet, idx) => (
                    <div key={idx} style={{ display: "flex", alignItems: "center", gap: "12px", fontSize: "15px", fontWeight: 600, color: "#1A2848" }}>
