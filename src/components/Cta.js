      ...
      <div className="site-container animate-fadeInUp" style={{ position: "relative", zIndex: 10 }}>
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "40px" }}>
          <div style={{ flex: "1 1 400px" }}>
            ...
            <p style={{ fontSize: "16px", color: "#475569", lineHeight: 1.7, marginBottom: "32px", maxWidth: "460px" }}>
              Book a demo today and see how Ovotech can transform your GP practice. Start saving time and reducing costs.
            </p>
            <Link href="/contact" style={{ background: "#02ACEA", color: "#FFFFFF", fontWeight: 700, fontSize: "14px", padding: "16px 32px", borderRadius: "12px", display: "inline-flex", alignItems: "center", gap: "8px", boxShadow: "0 6px 20px rgba(2, 172, 234, 0.25)", transition: "all 0.3s" }}
              onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 10px 25px rgba(2, 172, 234, 0.4)"; }}
              onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(2, 172, 234, 0.25)"; }}
            >
