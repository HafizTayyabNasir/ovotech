        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "100px" }}>
          ...
          <div style={{
            ...
            <div style={{ position: "relative" }}>
              <div style={{ borderRadius: "28px", overflow: "hidden", boxShadow: "0 20px 50px rgba(54,45,126,0.12)", border: "1px solid #E8E8EF" }}>
                <img
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: "13px", fontWeight: 800, color: "#1A1A1A" }}>EMIS Web Active</div>
                  <div style={{ fontSize: "11px", color: "#888" }}>Structured Write-Back</div>
                </div>
              </div>
            </div>

            <div>
              <span style={{ display: "inline-block", background: "rgba(54,45,126,0.08)", color: "#362D7E", fontSize: "12px", fontWeight: 700, padding: "6px 16px", borderRadius: "20px", textTransform: "uppercase", letterSpacing: "1.5px", marginBottom: "16px" }}>
                Clinical Intelligence &amp; Record Integrity
              </span>
              <h2 style={{ fontSize: "clamp(30px, 4vw, 42px)", fontWeight: 800, color: "#1A1A1A", lineHeight: 1.18, marginBottom: "20px" }}>
                Structured Consultation Notes Ready for Action
              </h2>
              <p style={{ fontSize: "16px", color: "#555555", lineHeight: 1.8, marginBottom: "28px" }}>
          ...
          <div style={{
            ...
            <div style={{ order: 1 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center" }}>
                <Link href="/contact" style={{ display: "inline-flex", alignItems: "center", gap: "8px", border: "2px solid #362D7E", color: "#362D7E", fontWeight: 700, fontSize: "14px", padding: "14px 28px", borderRadius: "12px", transition: "all 0.3s" }}>
            ...
            <div style={{ order: 2, position: "relative" }}>
              <div style={{ borderRadius: "28px", overflow: "hidden", boxShadow: "0 20px 50px rgba(0,0,0,0.1)", border: "1px solid #E8E8EF" }}>
                <img
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: "13px", fontWeight: 800, color: "#1A1A1A" }}>CQC Ready</div>
                  <div style={{ fontSize: "11px", color: "#888" }}>Full Audit Compliance</div>
                </div>
              </div>
            </div>
          </div>
