...
export default function Footer() {
  return (
    <footer style={{ background: "#000000", color: "#fff", paddingTop: "80px", borderTop: "1px solid rgba(255,255,255,0.08)", position: "relative", overflow: "hidden" }}>
      ...
      <div className="site-container" style={{ display: "flex", flexWrap: "wrap", gap: "60px", paddingBottom: "60px", position: "relative", zIndex: 10 }}>
        ...
        <div style={{ flex: "0 1 280px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "20px" }}>
            <img src="/logo-footer.png" alt="Ovotech Logo" style={{ height: "46px", width: "auto" }} />
          </div>
