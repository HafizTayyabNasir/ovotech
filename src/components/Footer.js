...
export default function Footer() {
  return (
    <footer style={{ background: "#0d0a1f", color: "#fff", paddingTop: "80px" }}>
        ...
        <div style={{ flex: "0 1 280px" }}>
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            {[
              ...
              <a key={i} href="#" aria-label={s.label} style={{ width: "36px", height: "36px", background: "rgba(255,255,255,0.1)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.3s" }} onMouseEnter={e => e.currentTarget.style.background = "#362D7E"} onMouseLeave={e => e.currentTarget.style.background = "rgba(255,255,255,0.1)"}>
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                {links.map((link, i) => (
                  <Link key={i} href={link.href} style={{ fontSize: "14px", color: "rgba(255,255,255,0.5)", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "#fff"} onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.5)"}>
                    {link.label}
                  </Link>
                ))}
              </div>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        <div className="site-container" style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", padding: "20px 0", gap: "16px", fontSize: "14px", color: "rgba(255,255,255,0.4)" }}>
          <span>&copy; 2025 Ovotech. All rights reserved.</span>
          <div style={{ display: "flex", gap: "24px" }}>
            <Link href="/privacy-policy" style={{ transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "#fff"} onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.4)"}>Privacy Policy</Link>
            <Link href="/terms" style={{ transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "#fff"} onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.4)"}>Terms &amp; Conditions</Link>
          </div>
        </div>
      </div>
    </footer>
