...
export default function InteractiveWorkflowShowcaseDark() {
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "4px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      ...
                      <span style={{ fontSize: "11px", fontWeight: 800, textTransform: "uppercase", letterSpacing: "1px", color: isActive ? "#0A1838" : "#02ACEA" }}>
                        {step.category}
                      </span>
                    </div>
