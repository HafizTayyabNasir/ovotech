...
export default function ROICalculator() {
  ...
  return (
    <section style={{ padding: "100px 0", background: "#B332D2", color: "#FFFFFF", position: "relative", overflow: "hidden" }}>
      <div className="site-container">
        ...
        <div style={{ background: "rgba(255,255,255,0.05)", backdropFilter: "blur(16px)", borderRadius: "24px", padding: "48px 36px", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "0 16px 40px rgba(0,0,0,0.3)", maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "48px", alignItems: "center" }}>
            ...
            <div style={{ background: "#B332D2", borderRadius: "20px", padding: "36px 30px", color: "#FFFFFF", border: "1px solid rgba(2,172,234,0.3)", boxShadow: "0 12px 30px rgba(0,0,0,0.3)" }}>
