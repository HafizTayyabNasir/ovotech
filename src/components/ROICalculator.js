    ...
    <section style={{ padding: "100px 0", background: "#FFFFFF", position: "relative", overflow: "hidden" }}>
      <div className="site-container">
        <div style={{ textAlign: "center", marginBottom: "50px" }}>
          ...
          <h2 style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 800, color: "#1A1A1A", lineHeight: 1.15 }}>
            Calculate Your Practice Capacity &amp; Time Released
          </h2>
          <p style={{ color: "#555555", fontSize: "16px", marginTop: "12px", maxWidth: "600px", marginLeft: "auto", marginRight: "auto" }}>
        ...
        <div style={{ background: "#F7F7FA", borderRadius: "24px", padding: "48px 36px", border: "1px solid #E8E8EF", boxShadow: "0 16px 40px rgba(54,45,126,0.06)", maxWidth: "1000px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "48px", alignItems: "center" }}>
            ...
            <div>
              ...
              <div style={{ marginBottom: "36px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                  <label style={{ fontSize: "15px", fontWeight: 700, color: "#1A1A1A" }}>Practice Patient List Size</label>
                  <span style={{ fontSize: "18px", fontWeight: 800, color: "#362D7E" }}>{listSize.toLocaleString()} Patients</span>
                </div>
                <input
                  type="range"
                  min="3000"
                  ...
                  style={{ width: "100%", accentColor: "#362D7E", cursor: "pointer", height: "8px", borderRadius: "4px" }}
                />
              ...
              <div style={{ marginBottom: "24px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                  <label style={{ fontSize: "15px", fontWeight: 700, color: "#1A1A1A" }}>Daily Clinical Letters Received</label>
                  <span style={{ fontSize: "18px", fontWeight: 800, color: "#362D7E" }}>{dailyLetters} Docs / Day</span>
                </div>
                <input
                  type="range"
                  min="15"
            ...
            <div style={{ background: "#060D1F", borderRadius: "20px", padding: "36px 30px", color: "#FFFFFF", border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 12px 30px rgba(0,0,0,0.2)" }}>
              <div style={{ fontSize: "12px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1.5px", color: "#A594FF", marginBottom: "20px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px", marginBottom: "32px" }}>
                ...
                <div>
                  <div style={{ fontSize: "32px", fontWeight: 800, color: "#A594FF", lineHeight: 1 }}>{fteReleased} FTE</div>
              ...
              <Link href="/contact" style={{ display: "block", textAlign: "center", background: "#362D7E", color: "#FFFFFF", fontWeight: 700, fontSize: "14px", padding: "14px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.2)", transition: "all 0.3s" }}>
