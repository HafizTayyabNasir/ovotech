      ...
      <div className="site-container">
        <div style={{ display: "flex", flexWrap: "wrap", gap: "60px", alignItems: "flex-start" }}>
          ...
          <div className="animate-fadeInLeft" style={{ flex: "1 1 500px" }}>
            <span style={{ display: "inline-block", fontSize: "12px", fontWeight: 700, letterSpacing: "2px", color: "#00A8E8", marginBottom: "12px", textTransform: "uppercase" }}>Complete Coverage</span>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 40px)", fontWeight: 800, color: "#0A1838", lineHeight: 1.2, marginBottom: "16px" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
              {tags.map((tag, i) => (
                <span key={i} className={`animate-scaleIn delay-${(i + 1) * 50}`} style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(0,168,232,0.08)", color: "#00A8E8", fontSize: "14px", fontWeight: 600, padding: "10px 20px", borderRadius: "30px", border: "1px solid rgba(0,168,232,0.2)", transition: "all 0.3s", cursor: "default" }}
                  onMouseEnter={e => { e.currentTarget.style.background = "#00A8E8"; e.currentTarget.style.color = "#fff"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "rgba(0,168,232,0.08)"; e.currentTarget.style.color = "#00A8E8"; }}
                >
          ...
          <div className="animate-fadeInRight delay-200" style={{ flex: "0 1 340px", display: "flex", flexDirection: "column", gap: "20px", width: "100%" }}>
            <div style={{ background: "linear-gradient(135deg, #09132B 0%, #0F214A 100%)", color: "#fff", borderRadius: "20px", padding: "32px", border: "1px solid rgba(0,168,232,0.3)" }}>
              ...
              <div style={{ fontSize: "40px", fontWeight: 800, marginBottom: "4px", color: "#00A8E8" }}>96%</div>
              <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.7)", marginBottom: "16px" }}>Client satisfaction rate</p>
              <Link href="/case-studies" style={{ fontSize: "14px", fontWeight: 600, color: "#00A8E8", display: "inline-flex", alignItems: "center", gap: "6px" }}>
                View Results <span>→</span>
              </Link>
            </div>
            <div style={{ background: "#fff", border: "2px solid rgba(0,168,232,0.15)", borderRadius: "20px", padding: "32px" }}>
              ...
              <div style={{ fontSize: "40px", fontWeight: 800, color: "#0A1838", marginBottom: "4px" }}>120+</div>
              <p style={{ fontSize: "14px", color: "#64748B", marginBottom: "16px" }}>Healthcare automation specialists</p>
              <Link href="/about" style={{ fontSize: "14px", fontWeight: 600, color: "#00A8E8", display: "inline-flex", alignItems: "center", gap: "6px" }}>
