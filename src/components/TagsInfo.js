      ...
      <div className="site-container">
        <div style={{ display: "flex", flexWrap: "wrap", gap: "60px", alignItems: "flex-start" }}>
          ...
          <div className="animate-fadeInLeft" style={{ flex: "1 1 500px" }}>
            <span style={{ display: "inline-block", fontSize: "12px", fontWeight: 700, letterSpacing: "2px", color: "#02ACEA", marginBottom: "12px", textTransform: "uppercase", background: "rgba(2,172,234,0.1)", padding: "4px 14px", borderRadius: "20px", border: "1px solid rgba(2,172,234,0.25)" }}>Complete Coverage</span>
          ...
          <div className="animate-fadeInRight delay-200" style={{ flex: "0 1 340px", display: "flex", flexDirection: "column", gap: "20px", width: "100%" }}>
            <div style={{ background: "#F0F9FF", color: "#0F172A", borderRadius: "20px", padding: "32px", border: "1px solid #BAE6FD", boxShadow: "0 10px 30px rgba(2,172,234,0.1)" }}>
              <div style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#02ACEA", marginBottom: "12px" }}>Happiness Score</div>
              <div style={{ fontSize: "40px", fontWeight: 800, marginBottom: "4px", color: "#02ACEA" }}>96%</div>
              <p style={{ fontSize: "14px", color: "#475569", marginBottom: "16px" }}>Client satisfaction rate</p>
              <Link href="/case-studies" style={{ fontSize: "14px", fontWeight: 700, color: "#02ACEA", display: "inline-flex", alignItems: "center", gap: "6px" }}>
                View Results <span>→</span>
              </Link>
            </div>
            <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F5", borderRadius: "20px", padding: "32px" }}>
              ...
              <Link href="/about" style={{ fontSize: "14px", fontWeight: 700, color: "#02ACEA", display: "inline-flex", alignItems: "center", gap: "6px" }}>
