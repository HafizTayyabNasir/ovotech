      ...
      <div className="site-container">
        <div style={{ display: "flex", flexWrap: "wrap", gap: "60px", alignItems: "flex-start" }}>
          ...
          <div className="animate-fadeInLeft" style={{ flex: "1 1 500px" }}>
            ...
            <h2 style={{ fontSize: "clamp(28px, 4vw, 40px)", fontWeight: 800, color: "#24144B", lineHeight: 1.2, marginBottom: "16px" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
              {tags.map((tag, i) => (
                <span key={i} className={`animate-scaleIn delay-${(i + 1) * 50}`} style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(138,96,229,0.1)", color: "#02ACEA", fontSize: "14px", fontWeight: 600, padding: "10px 20px", borderRadius: "30px", border: "1px solid rgba(138,96,229,0.25)", transition: "all 0.3s", cursor: "default" }}
                  onMouseEnter={e => { e.currentTarget.style.background = "#02ACEA"; e.currentTarget.style.color = "#fff"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "rgba(138,96,229,0.1)"; e.currentTarget.style.color = "#02ACEA"; }}
                >
          ...
          <div className="animate-fadeInRight delay-200" style={{ flex: "0 1 340px", display: "flex", flexDirection: "column", gap: "20px", width: "100%" }}>
            <div style={{ background: "linear-gradient(135deg, #24144B 0%, #301A65 100%)", color: "#fff", borderRadius: "20px", padding: "32px", border: "1px solid rgba(138,96,229,0.3)" }}>
            ...
            <div style={{ background: "#fff", border: "2px solid rgba(138,96,229,0.2)", borderRadius: "20px", padding: "32px" }}>
              ...
              <div style={{ fontSize: "40px", fontWeight: 800, color: "#24144B", marginBottom: "4px" }}>120+</div>
