      ...
      <div className="site-container">
        <div className="animate-fadeInUp" style={{ background: "linear-gradient(135deg, #f8fafc 0%, #EBF3FA 100%)", borderRadius: "24px", padding: "48px", display: "flex", flexWrap: "wrap", alignItems: "center", gap: "40px", border: "1px solid #e2e8f5" }}>
          ...
          <div style={{ flex: "1 1 400px" }}>
            ...
            <blockquote style={{ fontSize: "clamp(20px, 3vw, 24px)", fontWeight: 500, color: "#0f172a", lineHeight: 1.6, marginBottom: "32px", position: "relative" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
              ...
              <div>
                <strong style={{ fontSize: "16px", fontWeight: 700, color: "#0f172a", display: "block" }}>Dr. Sarah Mitchell</strong>
