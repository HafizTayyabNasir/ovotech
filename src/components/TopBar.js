      ...
      <div className="site-container flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          <Link href="/security-compliance" className="hover:text-white/80 transition-colors font-medium flex items-center gap-1.5">
            ...
            NHS DSPT &amp; DCB0129 Approved
          </Link>
          <Link href="/solutions#emis-integration" className="hover:text-white/80 transition-colors font-medium flex items-center gap-1.5">
          ...
          <Link href="/contact" className="hover:text-white/80 transition-colors font-medium flex items-center gap-1.5">
