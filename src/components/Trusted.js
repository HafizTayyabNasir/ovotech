    ...
    <section style={{ padding: "100px 0", background: "#f8fafc" }}>
      <div className="site-container">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "24px", marginBottom: "64px" }}>
          {pillars.map((s, i) => (
            ...
            >
              ...
              <div style={{ fontSize: "22px", fontWeight: 800, color: "#1A2848", marginBottom: "8px" }}>{s.title}</div>
        ...
        <div className="animate-fadeInUp delay-400" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", alignItems: "center", gap: "40px", marginBottom: "64px" }}>
          ...
          <span style={{ fontSize: "20px", fontWeight: 800, color: "#1A2848", letterSpacing: "1px" }}>EMIS Web</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px", marginBottom: "40px" }}>
          {standards.map((c, i) => (
            ...
            >
              <h4 style={{ fontSize: "16px", fontWeight: 700, color: "#1A2848", marginBottom: "8px" }}>{c.title}</h4>
