...
// 1. Swap the hero component `InteractiveWorkflowShowcaseDark` to `InteractiveWorkflowShowcaseThird`
...
console.log("Swapped to ShowcaseThird");
...
`;
replaceBlock(s3Start, s3End, s3New);
...
const s4New = `<div className="flex flex-col gap-6 mb-8">
            ...
            `;
replaceBlock(s4Start, s4End, s4New);
...
const s5New = `<div className="flex gap-3 mb-6 overflow-x-auto no-scrollbar pb-2">
              ...
              `;
replaceBlock(s5Start, s5End, s5New);
...
const s7New = `<div className="relative mb-12 bg-white border border-[#E0E8F5] rounded-3xl overflow-hidden shadow-lg">
          ...
          `;
replaceBlock(s7Start, s7End, s7New);
...
const s12New = `<div className="flex flex-col gap-8 mb-8">
              ...
              `;
replaceBlock(s12Start, s12End, s12New);
...
const s13New = `<div className="w-full relative py-12 mb-12 flex flex-col items-center">
            ...
            `;
replaceBlock(s13Start, s13End, s13New);
...
const s13bNew = `<div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
...
`;
replaceBlock(s13bStart, s13bEnd, s13bNew);
