...
if (!content.includes('<InteractiveWorkflowShowcaseThird />')) {
    ...
    if (iS4 !== -1) {
        ...
        const s4FallbackRegex = /\{\/\*\s*SECTION 4/i;
        content = content.replace(s4FallbackRegex, '{/* INTERACTIVE WORKFLOW SHOWCASE */}\\n      <InteractiveWorkflowShowcaseThird />\\n\\n      {/* SECTION 4');
        console.log("Inserted Showcase via fallback");
    }
}
...
const s2Repl = `          <div className="w-full py-12 relative overflow-x-auto no-scrollbar">
...
const s3End = '      {/* INTERACTIVE WORKFLOW SHOWCASE';
...
// 7. Section 8
const s8Start = '<div className="bg-[#112146] rounded-3xl p-8 lg:p-12 border-l-4 border-l-[#02ACEA] border-y border-r border-[#1C2C54] shadow-2xl flex flex-col md:flex-row items-center gap-8 md:gap-12 transform md:-translate-x-6">';
const s8End = '      {/* SECTION 9 — HUMAN OVERSIGHT */}';
const s8NewBlock = `<div className="max-w-4xl mx-auto w-full">
...
const s11NewBlock = `<div className="flex flex-col gap-12 w-full">
...
const s12New = `<div className="flex flex-col gap-8 mb-8 w-full">
...
const s13bNewBlock = `<div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto w-full">
